...
CREATE INDEX IF NOT EXISTS idx_audit_user_event ON audit_logs(user_id, event_type, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_audit_tenant_event ON audit_logs(tenant_id, event_type, timestamp DESC);
