...
func (s *Server) handleInitiateMultipartUpload(w http.ResponseWriter, _ *http.Request, bucket, object string) {
...
func (s *Server) handleCompleteMultipartUpload(w http.ResponseWriter, _ *http.Request, bucket, object string) {
