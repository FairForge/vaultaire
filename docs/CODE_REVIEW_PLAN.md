...
|---|---------|-----------|--------|---------------|-----|
| R0 | Dead code & scaffolding triage | — | **done 2026-09-26** — 41 pkgs + 77 files deleted (−83.5k LOC); post-merge review added R0-13..19 + test-DB isolation; 6 pkgs + 15 files await decisions D-1..D-10 | [R0-dead-code.md](reviews/R0-dead-code.md) | #473, follow-up PR pending |
